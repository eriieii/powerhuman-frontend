        ...
        <div class="lg:pr-[70px] py-[50px] lg:ml-[320px] xl:ml-[365px] px-4 lg:pl-0">
            ...
            <section class="flex flex-col flex-wrap justify-between gap-6 md:items-center md:flex-row">
                <div class="flex items-center justify-between gap-4">
                    <NuxtLink href="#" id="toggleOpenSidebar" class="lg:hidden">
            ...
            <section class="pt-[50px]">
                ...
                <div class="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4 xl:gap-10 lg:gap-3">
                    ...
                    <div class="items-center card py-6 md:!py-10 md:!px-[38px] !gap-y-0">
                        <NuxtLink href="#" class="absolute inset-0 focus:ring-2 ring-primary rounded-[26px]"></NuxtLink>
                    ...
                    <div class="items-center card py-6 md:!py-10 md:!px-[38px] !gap-y-0">
                        ...
                        <NuxtLink href="#verify" class="text-blue-700 mt-[30px] underline relative z-20">
                            Verify Now
                        </NuxtLink>
                    </div>
                    <!-- Card -->
